...
export const dictionaries = {
  id: {
    ...
    heroSubtitle: "Umumin mimpi kamu. Tanpa nama. Tanpa wajah. 🔒",
    ...
    shareSubtitle:
      "Pakai nama, emoji, atau anonymous. Bebas. 🔒",
    formName: "Namamu",
    ...
    storiesFormSubmit: "Kirim Cerita",
  ...
  en: {
    ...
    storiesFormSubmit: "Submit Story",
