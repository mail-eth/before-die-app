...
export const dictionaries = {
  id: {
    ...
    storiesSubtitle: "Cerita-cerita yang mungkin bisa bikin kamu refleksi.",
    ...
    storiesSuccessMessage: "Story kamu sudah dipublish. Terima kasih sudah berbagi.",
  ...
  en: {
    ...
    storiesSuccessMessage: "Your story has been published. Thank you for sharing.",
