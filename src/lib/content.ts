...
export const dictionaries = {
  id: {
    ...
    heroSubtitle: "Umumin mimpi lo. Gak perlu nama. Gak perlu wajah. Gak ada yang judged.",
    ...
    shareSubtitle:
      "Lo bebas pake nama, emoji, atau anonymous. Gak ada yang縛 lo.",
    formName: "Namamu",
    formDream: "Mimpi lo apa?",
    ...
    formPlaceholderReason: "Kenapa ini penting buat lo?",
    footerLine:
      "Lo bebas ngomong apa. Lo bebas jadi siapa. Before Die cuma想说 - ada yang lulus.",
